...
@app.route('/relatorios/relatorios-financeiros/dfc-categoria-detalhes/<int:categoria_id>', methods=['GET'])
@login_required
@requires_roles
def dfc_categoria_detalhes(categoria_id):
    """
    ...
    try:
        ...
        registros = db.session.query(AgendamentoPagamentoModel)\
            ...
            .filter(
                ...
                AgendamentoPagamentoModel.data_vencimento >= data_inicio,
                        ...
                        for categoria_info in categorias:
                            if isinstance(categoria_info, dict) and categoria_info.get('categoria_id') == categoria_id:
                                ...
                                registros_categoria.append({
                                    'id': registro.id,
                                    'data_competencia': registro.data_vencimento.strftime('%d/%m/%Y'),
