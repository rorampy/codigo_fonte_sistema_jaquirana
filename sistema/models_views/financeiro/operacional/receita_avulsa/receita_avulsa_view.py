...
@app.route("/financeiro/operacional/receitas-avulsas", methods=["GET"])
@login_required
@requires_roles
def listagem_faturamentos_receitas_avulsas():
    """
    Lista todos os faturamentos de receitas avulsas.
    """
    try:
        ...
        return render_template(
            "financeiro/operacional/receitas/listagem_faturamentos_receitas_avulsas.html",
...
@app.route("/financeiro/operacional/receita-avulsa/detalhes/<int:id>", methods=["GET"])
@login_required  
@requires_roles
def detalhes_faturamento_receita_avulsa_ajax(id):
    """
    ...
    try:
        ...
        dados_faturamento = {
            ...
            "valor_total": formatar_valor(faturamento.valor_receita),
        ...
        return jsonify({
            ...
            "receitas_avulsas": receita_avulsa,
        })
...
@app.route("/financeiro/operacional/categorizacao/receitas-avulsas/detalhes-json/<int:id>", methods=["GET"])
@login_required
@requires_roles
...
@app.route('/financeiro/operacional/receitas-avulsas/exportar-imagem/<int:faturamento_id>', methods=['GET','POST'])
@login_required
@requires_roles
...
def processar_dados_faturamento(faturamento):
    ...
    dados = {
        'faturamento': {
            ...
            'tipo_operacao': 'Receitas Avulsas',
            'direcao_financeira': 'Receita',
            'situacao': faturamento.situacao.situacao if faturamento.situacao else 'Pendente'
        }
    }
    ...
    if faturamento.lancamento_avulso:
        ...
        receitas_processadas.append(receita_data)
