...
def listagem_faturamentos_despesas_avulsas():
    ...
    try:
        ...
        print(f"[ERROR listagem_faturamentos_despesas_avulsas] {e}")
...
def detalhes_categorizacao_faturamento_despesa_avulsa_json(id):
    ...
    try:
        ...
        # Verificar se é um faturamento de controle de despesas
...
def exportar_despesa_avulsa_pdf(faturamento_id):
    ...
    try:
        ...
        # Verificar se é um faturamento de despesas avulsas
        if faturamento.tipo_operacao != 2 or faturamento.direcao_financeira != 2:
        ...
        # Renderizar template HTML específico para despesas avulsas
        ...
        print(f"[ERROR exportar_despesa_avulsa_pdf] {e}")
...
def exportar_despesa_avulsa_imagem(faturamento_id):
    ...
    try:
        ...
        # Renderizar template HTML específico para despesas avulsas (versão imagem)
        ...
        print(f"[ERROR exportar_despesa_avulsa_imagem] {e}")
...
def processar_dados_faturamento(faturamento):
    ...
    # Não há outros tipos de dados em despesas avulsas
    dados['fornecedores'] = {}
