...
class ParcelaCategorizacaoModel(BaseModel):
    ...
    descricao = db.Column(db.Text, nullable=True)  # Descrição da parcela
    referencia = db.Column(db.String(200), nullable=True)  # Referência da parcela 
    ...
    # Dados do pagamento (quando paga)
