...
def emitir_nfs_complementares_em_massa():
    ...
    if request.method == "POST":
        return processar_emissao_formulario()

def processar_emissao_formulario():
    """Processa emissão via formulário com upload de PDF"""
    ...
    try:
        ...
        peso_total_selecionado = abs(float(request.form.get('peso_total_selecionado', 0)))
        ...
        if gravar_banco:
            ...
            # Salva as primeiras informações da NF Complementar
